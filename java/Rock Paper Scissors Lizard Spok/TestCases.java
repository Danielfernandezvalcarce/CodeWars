...
class SolutionTest {  
  ...
  private static Map<String,String> OUTCOME = Map.of(
  ...
  private static String[] CNDS = {"scissors","paper","rock","lizard","spock"};
  private static Random R = new Random();
  private static String choice(){ return CNDS[R.nextInt(CNDS.length)]; }
